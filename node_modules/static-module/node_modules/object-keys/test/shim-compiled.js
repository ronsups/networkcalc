...
test('throws an error for a non-object', function (t) {
	t.throws(function () {
		return keys(42);
	}, new TypeError('Object.keys called on a non-object'), 'throws on a non-object');
	t.end();
});
...
test('shadowed properties', function (t) {
	var shadowedProps = ['dummyControlProp', /* just to be sure */
...
//# sourceMappingURL=shim-compiled.js.map