...
test('#62: deep module references and the pathFilter', function (t) {
  ...
  var pathFilter = function pathFilter(pkg, x, remainder) {
  ...
  resolve('deep/deeper/ref', { basedir: resolverDir }, function (err, res, pkg) {
    if (err) t.fail(err);
...
//# sourceMappingURL=pathfilter-compiled.js.map