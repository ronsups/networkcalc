...
define(function (require, exports, module) {
  ...
  exports['test the two additional parameters of applySourceMap'] = function (assert, util) {
    ...
    var expectedMap = function expectedMap(sources) {
      var map = new SourceMapGenerator({
        file: 'bundle.min.js',
        sourceRoot: '..'
      });
    ...
    var actualMap = function actualMap(aSourceMapPath) {
  ...
  exports['test applySourceMap name handling'] = function (assert, util) {
    ...
    var assertName = function assertName(coffeeName, jsName, expectedName) {
      var minifiedMap = new SourceMapGenerator({
        file: 'test.js.min'
      });
      minifiedMap.addMapping({
...
//# sourceMappingURL=test-source-map-generator-compiled.js.map