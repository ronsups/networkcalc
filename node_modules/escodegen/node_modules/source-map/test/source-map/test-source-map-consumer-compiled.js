...
define(function (require, exports, module) {
  ...
  exports['test github issue #43'] = function (assert, util) {
    ...
    assert.equal(sources[0], 'http://cdn.example.com/original.js', 'Should not be joined with the sourceRoot.');
  };
  ...
  exports['test absolute path, but same host sources'] = function (assert, util) {
    ...
    var sources = map.sources;
    assert.equal(sources.length, 1, 'Should only be one source.');
    assert.equal(sources[0], 'http://example.com/original.js', 'Source should be relative the host of the source root.');
  };
...
//# sourceMappingURL=test-source-map-consumer-compiled.js.map